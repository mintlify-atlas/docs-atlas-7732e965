...
curl -X GET "https://api.example.com/report/csp/autorizacion-proyecto-externo/123?l=es" \
...
const response = await fetch(
  'https://api.example.com/report/csp/autorizacion-proyecto-externo/123?l=en',
  {
    headers: {
...
response = requests.get(
    'https://api.example.com/report/csp/autorizacion-proyecto-externo/123',
...
fetch('https://api.example.com/report/csp/autorizacion-proyecto-externo/123', {
